Pod::Spec.new do |s|
  ...
  s.version      = "0.4"
  s.summary      = "TDNotificationPanel is a drop in class that displays a notification which can contain a title, subtitle, icon, progress bar or activity indicator."
  ...
  s.source       = { :git => "https://github.com/tomdiggle/TDNotificationPanel.git", :tag => "0.4" }
  s.requires_arc = true
  s.platform     = :ios, '5.0'
